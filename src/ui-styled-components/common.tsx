...
export const Block = styled.div`
  ...
  flex-direction: ${(props: BlockProps) => props.flexDirection ? props.flexDirection : "row"};
  justify-content: ${(props: BlockProps) => props.justifyContent ? props.justifyContent : "center"};
  align-items: ${(props: BlockProps) => props.alignItems ? props.alignItems : "center"};
  width: ${(props: BlockProps) => props.width ? props.width : "auto"};
  min-width: ${(props: BlockProps) => props.minWidth ? props.minWidth : "auto"};
  height: ${(props: BlockProps) => props.height ? props.height : "100%"};
  min-height: ${(props: BlockProps) => props.minHeight ? props.minHeight : "auto"};;
  padding: ${(props: BlockProps) => props.padding ? props.padding : 0};
  margin: ${(props: BlockProps) => props.margin ? props.margin : 0};
  background: ${(props: BlockProps) => props.background ? props.background : "none"};
  box-shadow: ${(props: BlockProps) => props.boxShadow ? props.boxShadow : "none"};
  border: ${(props: BlockProps) => props.border ? props.border : "none"};
  flex-wrap : ${(props: BlockProps) => props.flexWrap ? props.flexWrap : "wrap"};
  border-radius:  ${(props: BlockProps) => props.borderRadius ? props.borderRadius : "0"};
  cursor: ${(props: BlockProps) => props.cursor ? props.cursor : "auto"};
  border-bottom: ${(props: BlockProps) => props.borderBottom ? props.borderBottom : "auto"};
  border-top: ${(props: BlockProps) => props.borderTop ? props.borderTop : "auto"};
  border-left: ${(props: BlockProps) => props.borderLeft ? props.borderLeft : "auto"};
  border-right: ${(props: BlockProps) => props.borderRight ? props.borderRight : "auto"};
  overflow-y: ${(props: BlockProps) => props.overflowY ? props.overflowY : ""};
  overflow-x: ${(props: BlockProps) => props.overflowX ? props.overflowX : ""};
...
export const StyledSvg = styled.svg`
 cursor: pointer;
  margin: ${(props: StyledSvgProps) => props.margin ? props.margin : "0 12px 0 0"};
`
// -------------------------------------------------StyledSelect-----------------------------------------------------
...
export const StyledSelect = styled(Select)`
  ...
  height: ${(props: StyledSelectProps) => props.height ? props.height : "100%"};
  padding: ${(props: StyledSelectProps) => props.padding ? props.padding : 0};
  border: ${(props: StyledSelectProps) => props.border ? props.border : "none"};
`
...
export const Text = styled.span`
  font-size: ${(props: TextProps) => props.fontSize ? props.fontSize : "16px"};
  font-weight: ${(props: TextProps) => props.fontWeight ? props.fontWeight : "400"};
  font-family: ${(props: TextProps) => props.font ? props.font : "Roboto Regular"}, sans-serif;
  opacity: ${(props: TextProps) => props.opacityText ? props.opacityText : "1"};
  ...
  border-bottom : ${(props: TextProps) => props.borderBottom ? props.borderBottom : "0"};
...
export const StyledButton = styled.button`
  ...
  height: ${(props: StyledButtonProps) => props.height ? props.height : "auto"};
  background:  ${(props: StyledButtonProps) => props.background ? props.background : "#FCFCFC"};
  box-shadow:  ${(props: StyledButtonProps) => props.boxShadow ? props.boxShadow : "none"};
  border-radius:  ${(props: StyledButtonProps) => props.borderRadius ? props.borderRadius : "5px"};
  border:  ${(props: StyledButtonProps) => props.border ? props.border : "none"};
